package com.fisc.demande.web.rest;

import com.fisc.demande.DemandeApp;
...
@SpringBootTest(classes = DemandeApp.class)
@DirtiesContext(classMode = DirtiesContext.ClassMode.BEFORE_CLASS)
public class DemandeKafkaResourceIT {
    ...
    @Autowired
    private DemandeKafkaProducer producer;

    @Autowired
    private DemandeKafkaConsumer consumer;
    ...
    @BeforeEach
    public void setup() {
        DemandeKafkaResource kafkaResource = new DemandeKafkaResource(producer);
    ...
    public void producedMessageHasBeenConsumed() throws Exception {
        restMockMvc.perform(post("/api/demande-kafka/publish?message=test"))
